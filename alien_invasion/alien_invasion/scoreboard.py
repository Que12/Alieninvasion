...
class Scoreboard():
    ...
    def __init__(self, ai_settings, screen, stats):
        ##inicjalizowanie atrybutow dotyczacych punktacji
        self.screen = screen
        self.screen_rect = screen.get_rect()
        self.ai_settings = ai_settings
        self.stats = stats

        #ustawienia czcionki dla informacji dytyczących punktacji
    ...
    def prep_score(self):
        ...
        #wyswietlanie punktacji w prawym gornym rogu ekranu
    ...
    def prep_high_score(self):
        ...
        #wyswietlanie najlpeszego wyniku w grze na srodku ekranu przy gornej krawdzie 
